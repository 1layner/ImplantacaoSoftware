...
public class ServicePath {
	...
	public static final String EVENTO_PATH = PRIVATE_ROOT_PATH + "/evento";
	...
	public static final String USUARIO_INSCRICAO_PATH = PRIVATE_ROOT_PATH + "/usuarioinscricao";
	
	public static final String USUARIOS_PATH = PRIVATE_ROOT_PATH + "/usuario";
